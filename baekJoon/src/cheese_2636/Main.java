...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(solution.printCountLastCheese());
    }
}
...
class Solution {
    ...
    public int printCountLastCheese() {
        return countLastCheese;
    }
}
